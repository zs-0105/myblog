...
const cdn = {
   ...
   // 生产环境 
	build: {
	  css: ['https://cdn.bootcdn.net/ajax/libs/element-ui/2.15.6/theme-chalk/index.css'],
	  js: [
...
module.exports={
	...
	devServer: {
		...
		// proxy: {
		// 	'^/api': {
		// 		target: process.env.VUE_APP_SSO,//process.env.VUE_APP_SSO', // 重写路径
		// 		ws: false, //开启WebSocket
		// 		secure: false, // 如果是https接口，需要配置这个参数
		// 		changeOrigin: false,
		// 		pathRewrite: {
		// 			// '^/api'是一个正则表达式，表示要匹配请求的url中，全部'http://localhost:8080/api' 转接为 http://zhangshui.club:8088/api/user/
		// 			'^/api': '',
		// 		}
		// 	}
		// }
